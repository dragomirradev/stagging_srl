...
parser.add_argument("--language",
                    ...
                    choices=['eng', 'zh', 'cz', 'es', 'de'], default='eng')
...
parser.add_argument("--stag_type",
                    ...
                    choices=['model0', 'model1', 'model2', 'modelx', 'model3', 'modeltag', 'modeltagpos', 'model1pos'],
                    default='model1')
parser.add_argument("--stags_dir",
                    help="Training Stag Directory",
                    choices=['gold', 'pred', 'malt', 'pred_pos', 'predicted_stag_0.5', 'pred_new', 'pred_elmo'], default='pred')
...
def train(args):
    ...
    if args.language == 'eng':
        fn_preds_valid = 'data/{}/conll09/pred/_dev_predicates_mt.txt'.format(args.language)
    else:
        fn_preds_valid = 'data/{}/conll09/gold/dev_predicates.txt'.format(args.language)
    if args.use_stags:
