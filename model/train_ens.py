...
parser.add_argument("--stags_dir",
                    ...
                    choices=['gold', 'pred', 'malt', 'pred_pos', 'predicted_stag_0.5'], default='pred')
...
def train(args):
    ...
    model_dir = 'output/models/srlens' + model_suffix + '/'
    ...
    with tf.Graph().as_default():
        ...
        model = SRL_Model_Ens(vocabs, args)
